...
- Updated public feature-count references to 32 features in `docs/index.html`, `docs/features.html`, and `reference requirements/docs/features.md`.
...
- `CLAUDE.md` (repo root) — added agent development instructions: source-of-truth pointer to `reference requirements/instructions/`, skill/hook standards, pre-commit validation checklist, sequential commit requirements, full validation protocol
